...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 20, minZoom: 3, projection: new ol.proj.Projection({
            code: 'EPSG:32643',
...
map.getView().fit([273962.936749, 2115385.774593, 274706.238083, 2115773.296463], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Gaothan</h2>';
        return titleElement;
    })(),
